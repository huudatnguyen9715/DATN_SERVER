...
// GET MIN VALUE, DATE
$query = "SELECT value, date FROM temperature4 WHERE date BETWEEN '{$start}' AND '{$end}'";
...
// GET AVERAGE
$query = "SELECT AVG(value) AS ave FROM temperature4 WHERE date BETWEEN '{$start}' AND '{$end}'";
$result = mysqli_query($con, $query);

        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                    <?php
                        ...
                        $number = 1;
                        echo '<table class="table table-hover table-condensed display" id="example2" cellspacing="0" width="100&deg c">';
                        echo '<thead>';
                        echo '<tr>';
                        echo '<th>#</th>';
                        echo '<th>Location</th>';
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <?php
                    ...
                    $number = 1;
                    echo '<table class="table table-hover table-condensed display" id="example" cellspacing="0" width="100&deg c">';
                    echo '<thead>';
                    echo '<tr>';
                    echo '<th>#</th>';
                    echo '<th>Location</th>';
    ...
    function get_day_stat(){
        $.ajax({
            ...
            success: function(data){
                ...
                console.log(vals[3]);
                console.log(vals[4]);
                document.getElementById("min_hum").innerHTML = vals[0]+"&deg c";
                document.getElementById("min_time").innerHTML = vals[1];
                document.getElementById("max_hum").innerHTML = vals[2]+"&deg c";
                document.getElementById("max_time").innerHTML = vals[3];
                document.getElementById("ave_hum").innerHTML = vals[4]+"&deg c";

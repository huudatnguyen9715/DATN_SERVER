...
<div class="row">
    <div class="col-md-6 col-md-6 col-sm-6">
        ...
        <?php
            // GET LAST HUMIDITY
            $query = "SELECT value FROM humidity3 ORDER BY ID DESC LIMIT 1;";
    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Live Lux</h3>
            </div>
            <div class="box-body">
                    <?php
                        $query = "SELECT * FROM humidity3 ORDER BY id DESC LIMIT 10";
                        $result = mysqli_query($con, $query);  
                        
                        $number = 1;
                        echo '<table class="table table-hover table-condensed display" id="example2" cellspacing="0" width="99999Lux">';
                        echo '<thead>';
                        echo '<tr>';
                        echo '<th>#</th>';
                        echo '<th>Location</th>';
...
<div class="row hide" id="stat_graph">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-body">
                <?php
                    $query = "SELECT * FROM humidity3 ORDER BY id DESC";
                    $result = mysqli_query($con, $query);  
                    
                    $number = 1;
                    echo '<table class="table table-hover table-condensed display" id="example" cellspacing="0" width="99999Lux">';
                    echo '<thead>';
                    echo '<tr>';
                    echo '<th>#</th>';
                    echo '<th>Location</th>';
    ...
    function get_day_stat(){
        $.ajax({
            ...
            success: function(data){
                ...
                console.log(vals[3]);
                console.log(vals[4]);
                document.getElementById("min_hum").innerHTML = vals[0]+"Lux";
                document.getElementById("min_time").innerHTML = vals[1];
                document.getElementById("max_hum").innerHTML = vals[2]+"Lux";
                document.getElementById("max_time").innerHTML = vals[3];
                document.getElementById("ave_hum").innerHTML = vals[4]+"Lux";

...
<div class="row">
    <div class="col-md-6 col-md-6 col-sm-6">
        ...
        <?php
            // GET LAST TEMP
            $query = "SELECT value FROM temperature2 ORDER BY ID DESC LIMIT 1;";
        ...
        <div class="box  box-stat">
            <div class="box-body">
                <div style="display: block;">
                    <h4>9.2020<small class="pull-right"> Statistic</small></h4>
...
<div class="row " id="stat_table">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-body">
                    <?php
                        $query = "SELECT * FROM temperature2 ORDER BY id DESC LIMIT 10";
                        $result = mysqli_query($con, $query);  
                        
                        $number = 1;
                        echo '<table class="table table-hover table-condensed display" id="example2" cellspacing="0" width="100broken">';
                        echo '<thead>';
                        echo '<tr>';
                        echo '<th>#</th>';
                        echo '<th>Location</th>';
...
<div class="row hide" id="stat_graph">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-body">
                <?php
                    $query = "SELECT * FROM temperature2 ORDER BY id DESC";
                    $result = mysqli_query($con, $query);  
                    
                    $number = 1;
                    echo '<table class="table table-hover table-condensed display" id="example" cellspacing="0" width="100broken">';
                    echo '<thead>';
                    echo '<tr>';
                    echo '<th>#</th>';
                    echo '<th>Location</th>';
    ...
    function get_day_stat(){
        $.ajax({
            ...
            success: function(data){
                ...
                console.log(vals[3]);
                console.log(vals[4]);
                document.getElementById("min_temp").innerHTML = vals[0]+"broken";
                document.getElementById("min_time").innerHTML = vals[1];
                document.getElementById("max_temp").innerHTML = vals[2]+"broken";
                document.getElementById("max_time").innerHTML = vals[3];
                document.getElementById("ave_temp").innerHTML = vals[4]+"broken";

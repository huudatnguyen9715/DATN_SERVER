...
<div class="row">
    <div class="col-md-6 col-md-6 col-sm-6">
        ...
        <?php
            // GET LAST TEMP
            $query = "SELECT value FROM temperature3 ORDER BY ID DESC LIMIT 1;";
...
<div class="row " id="stat_table">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-body">
                    <?php
                        $query = "SELECT * FROM temperature3 ORDER BY id DESC LIMIT 10";
                        $result = mysqli_query($con, $query);  
...
<div class="row hide" id="stat_graph">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-body">
                <?php
                    $query = "SELECT * FROM temperature3 ORDER BY id DESC";
                    $result = mysqli_query($con, $query);  

...
// GET MIN VALUE, DATE
$query = "SELECT value, date FROM temperature3 WHERE date BETWEEN '{$start}' AND '{$end}'";
...
// GET AVERAGE
$query = "SELECT AVG(value) AS ave FROM temperature3 WHERE date BETWEEN '{$start}' AND '{$end}'";
$result = mysqli_query($con, $query);

...
<div class="row">
    <div class="col-md-6 col-md-6 col-sm-6">
        ...
        <?php
            // GET LAST TEMP
            $query = "SELECT value FROM temperature4 ORDER BY ID DESC LIMIT 1;";
        ...
        <div class="box  box-stat">
            <div class="box-body">
                <div style="display: block;">
                    <h4>4.2019<small class="pull-right"> Statistic</small></h4>
    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Live PH</h3>
            </div>
            <div class="box-body">
                    <?php
                        $query = "SELECT * FROM temperature4 ORDER BY id DESC LIMIT 10";
                        $result = mysqli_query($con, $query);  
...
<div class="row hide" id="stat_graph">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-body">
                <?php
                    $query = "SELECT * FROM temperature4 ORDER BY id DESC";
                    $result = mysqli_query($con, $query);  
